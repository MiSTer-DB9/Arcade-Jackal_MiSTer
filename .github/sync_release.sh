...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Jackal_MiSTer.git"
CORE_NAME=(Arcade-Jackal)
...
UPSTREAM_CORE_NAME=(Arcade-Jackal)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Jackal.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Jackal.rbf)
